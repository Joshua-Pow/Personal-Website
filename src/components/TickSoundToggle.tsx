  ...
  return (
    <button
      ...
      className={cn(
        ...
        "active:scale-[0.94] motion-reduce:transition-none"
      )}
    >
      <svg
        viewBox="0 0 24 24"
      ...
      >
        ...
        >
          <path d="M4.8 11.2c0.8-0.5 1.7-0.7 2.6-0.5" strokeWidth="1.1" />
          <path d="M4.2 13.6c1-0.3 2-0.2 2.9 0.3" strokeWidth="1.1" />
          <path d="M4.9 16c0.9 0.4 1.8 0.6 2.7 0.4" strokeWidth="1.1" />
        </motion.g>
      </svg>
    </button>
  );
